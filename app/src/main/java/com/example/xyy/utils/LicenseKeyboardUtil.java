...
import com.example.xyy.junparking.LicenseActivity;
    ...
    private OnKeyboardActionListener listener = new OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            if(primaryCode == 112){ //xml中定义的删除键值为112
                ...
                //intent.putExtra(LicenseActivity.INPUT_LICENSE_KEY, license);
                //ntent.setAction(LicenseActivity.INPUT_LICENSE_COMPLETE);
